...
const About: React.FC = () => {
    return (
        <div className="px-10 pb-[150px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 w-[300px] lg:w-[800px] mx-auto">
                <Description className="ml-8 lg:ml-40 text-xl">
                    Name:
                    <span className="ml-2">최성운</span>
                </Description>
                <Description className="ml-8 lg:ml-28 text-xl">
                    Age:
                    <span className="ml-2">2000.02.08</span>
                </Description>
                <Description className="ml-8 lg:ml-40 text-xl">
                    Phone:
                    <span className="ml-2">010-4316-4816</span>
                </Description>
                <Description className="ml-8 lg:ml-28 text-xl">
                    Email:
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 w-[300px] lg:w-[800px] mx-auto gap-4">
                <LicenseDescription className="ml-8 lg:ml-28 text-xl">
                    컴퓨터그래픽스운용기능사
                    <br/>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 w-[400px] lg:w-[1000px] mx-auto gap-4">
                <AwardsDescription className="ml-10 lg:ml-40 text-xl">
                    게임개발 지방기능경기대회 동메달
                    <br/>
